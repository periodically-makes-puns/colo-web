...
const redirect = encodeURIComponent('http://localhost:50541/api/discord/callback');
const redirect0 = encodeURIComponent('http://localhost:50541/api/discord/callback?cookie=0');
const redirect1 = encodeURIComponent('http://localhost:50541/api/discord/callback?cookie=1');
